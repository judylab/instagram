...
let profileEditButton= document.querySelector("#button button")
...
function(e){
    ...
    changing= false
        ...
        let_userInfo = userInfo.textContent
        let_summary = summary.textContent
        let_profileDetail= profileDetail.textContent
